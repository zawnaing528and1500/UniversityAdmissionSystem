...
while(rs.next())
{
	...
	m2.getConnection();
	String studentName = m2.getStudentName(studentId);
	int markForCurrentStudent = m2.getMark(studentId);
	String gendeForCurrentStudent = m2.getGender(studentId);
	...
	%>
	<tr><td><%= studentName %></td><td><%= markForCurrentStudent %></td><td><%= gendeForCurrentStudent %></td><td><%= universityName1 %></td><td><%= universityName2 %></td><td><%= universityName3 %></td><td><%= universityName4 %></td><td><%= universityName5 %></td><td><%= universityName6 %></td></tr>
	<%
}
%>
</table>
