...
<table bgColor="white">
	...
	<tr class=""><td><font color="#FFA07A"><%= region %></td></font><td><center><a onclick="document.getElementById('id02').style.display='block'"><img src="http://localhost:8080/UniversityAdmissionSystem/external/img/icon/comment.png" alt="write comment"></a></center></td></tr>
</table>
</form>
