...
<form class=".form-basic" action="updateUniversity.jsp" method="POST">
					...
					<div class="s-12 m-6 l-4 margin-bottom"><font color="#FFDEAD">Male Mark</font><br><input type="text" name="minMarkForMale" value="<%= minMarkForMale %>" required></div>
					<div class="s-12 m-6 l-4 margin-bottom"><font color="#FFDEAD">Female Mark</font><br><input type="text" name="minMarkForFemale" value="<%= minMarkForFemale%>" required></div>
					<div class="s-12 m-6 l-4 margin-bottom"><font color="#FFDEAD">Male Capacity</font><br><input type="text" name="maleCapacity" value="<%= maleCapacity %>" required></div>
					<font color="#FFDEAD">Female Capacity</font><br><input type="text" name="femaleCapacity" value="<%= femaleCapacity %>" required>
