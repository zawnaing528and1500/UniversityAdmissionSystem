...
<form class=".form-basic" action="updateUniversityWithNoGenderYes.jsp" method="POST">
					...
					<div class="s-12 m-6 l-12 margin-bottom"><font color="#FFDEAD">Capacity</font><br><input type="text" name="totalCapacity" value="<%= totalCapacity %>" required></div>
