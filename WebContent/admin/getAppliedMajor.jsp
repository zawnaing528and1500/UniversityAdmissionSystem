...
<div class="line">
<%
String currentUniversityName = request.getParameter("universityName");
...
f.getConnection();
ResultSet rs = f.getAppliedMajor(currentUniversityName);
%>
<center>
<table bgcolor="white">
<tr><th><font color="chocolate" size="3px">Number</font></th><th><font color="chocolate" size="3px">University's Major Name</font></th><th><font color="chocolate" size="3px">Number of Applied Student</font></th><th><font color="chocolate" size="3px">Number of Accepted Student</font></th></tr>
<%
while(rs.next())
{
