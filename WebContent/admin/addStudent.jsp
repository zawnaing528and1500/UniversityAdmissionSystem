...
m.getConnection();
m.insertStudent(studentName, Gender, NRC, studentRollNumber, subjectType, subject1Mark, subject2Mark, subject3Mark, subject4Mark, subject5Mark, subject6Mark);
%>
<script>
swal(
		  'You have successfully inserted a new Student!',
		  'inserted',
		  'success'
		)
	setTimeout(function() {
