...
ads.getConnection();
ResultSet rs1 = ads.getUniversityById(1);
while(rs1.next())
{
...
%>
<div class="box">
<center><font class="bodyText" color="#E9967A">Add University</font></center>
<form class=".form-basic" action="newPost.jsp" method="POST">

					<center><div class="line"><input type='file' onchange="readURL(this);" name="uploadImage" accept="image/gif, image/jpeg, image/png"/>
					<img id="blah" src="#" alt=" "/><br></div></center>
					
					<div class="s-12 m-6 l-4 margin-bottom"><font color="#FFDEAD">University Name</font><br><input type="text" name="universityName" placeholder="Enter University Name" required></div>
