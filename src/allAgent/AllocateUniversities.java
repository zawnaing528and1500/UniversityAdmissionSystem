...
public class AllocateUniversities {

	public AllocateUniversities() {
		// TODO Auto-generated constructor stub
	}
	
	public void allocate()
	{
		int minMark = 0,capacity = 0,limitCapacity = 0,limitTotalCapacity = 0, currentTotalCapacity = 0,studentId = 1,count = 1;
		String noGender;
